(function ($) {
    ...
    $.fn.inputTags.defaults = {
        ...
        errors: {
            empty: 'Opgelet, tag kan niet leeg zijn.',
            minLength: 'Opgelet, Tag moet minimaal %s karakters zijn.',
            maxLength: 'Opgelet, Tag mag maximaal %s karakters zijn.',
            max: 'Opgelet, Maximaal %s tags zijn toegestaan.',
            email: 'Opgelet, Emailadressen zijn niet toegestaan.',
            exists: 'Opgelet, Tag bestaat al.',
            timeout: 4000
        }
    };
